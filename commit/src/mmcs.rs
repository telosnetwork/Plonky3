...
///
/// It supports committing to matrices and then opening rows. It is also batch-oriented;
/// one can commit to a batch of matrices at once even if their widths and heights differ.
///
