...
/// of that circulant matrix.
///
/// For example, v = [0, 1, 2, 3, 4, 5], then output = [0, 5, 4, 3, 2, 1],
...
///
/// The circulant matrix must be specified by its first *column*, not its first row.
/// If you have the row as an array, you can obtain the column with `first_row_to_first_col()`.
#[inline]
